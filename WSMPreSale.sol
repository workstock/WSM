...
contract WSMCrowdsale is Pausable {
    using SafeMath for uint256;

    address public investWallet1 = 0x14723a09acff6d2a60dcdf7aa4aff308fddc160c;
    ...
    function WSMCrowdsale(address _tokenReward) {
        tokenReward = WSMToken(_tokenReward);
        investWallet1 = msg.sender;
    }
